...
<body>
	<div class="container">
		<div class="menu" style="position: sticky; top: 0; z-index: 1070;">
			<?php 
			include './menu.php';
			?>
		</div>
		<div class="conteudo">
			<?php 
			$pg = array('home.php','cria.lotes.php','enche.lote.php','lotes.php','ver.php','editar.php','apagar.lote.php','desmembrar.php');
