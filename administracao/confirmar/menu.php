...
<nav class="navbar navbar-expand-xl navbar-dark bg-dark" style="font-size: 20px">
	<ul class="navbar-nav mr-auto">
		...
		<li class="nav-item dropdown active">
			...
			<div class="dropdown-menu" aria-labelledby="navbarDropdown">
				<a class="dropdown-item" href="./?pg=1">Animais</a>
				<a class="dropdown-item" href="./?pg=0">Compradores</a>
				<a class="dropdown-item" href="./?pg=3">Leilões</a>
				<a class="dropdown-item" href="./">Comp/Lote</a>
				<div class="dropdown-divider"></div>
				<a class="dropdown-item" href="./?pg=2">Logo</a>
			</div>
		</li>
		<li class="nav-item dropdown">
			<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
